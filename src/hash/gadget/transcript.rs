...
use crate::hash::spec::Spec;

use halo2_proofs::{arithmetic::CurveAffine, halo2curves::ff::PrimeField, plonk::Error};
use crate::hash::gadget::hasher::HasherChip;
...
mod tests {
    ...
    use crate::hash::gadget::transcript::{LimbRepresentation, TranscriptChip};
